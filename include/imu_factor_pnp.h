    ...
    virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
    {
        ...
        if (jacobians)
        {
            ...
            if (jacobians[2]) //bias i
            {
                ...
                jacobian_bias_i.block<3, 3>(O_V, O_BA - O_V - O_R) = -dv_dba;//(6, 0)
                jacobian_bias_i.block<3, 3>(O_V, O_BG - O_V - O_R) = -dv_dbg;//(6, 3)
                
                jacobian_bias_i.block<3, 3>(O_BA, O_BA - O_V - O_R) = -Eigen::Matrix3d::Identity();//(9, 0)
                
                jacobian_bias_i.block<3, 3>(O_BG, O_BG - O_V - O_R) = -Eigen::Matrix3d::Identity();//(12, 3)
